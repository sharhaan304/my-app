...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("sharhaanmfm@gmailcom");
    setCopied(true);
  }
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(4,7,29,1) 0%, rgba(12,14,35,1) 35%, rgba(12,14,35,1) 100%)',
      }}
    >
                    ...
                    id === 3 && (
                        <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                            <div className="flex flex-col gap-3 lg:gap-5">
                                ...
                                {['Python','JAVA','SQL/NoSQL'].map((item) => (
